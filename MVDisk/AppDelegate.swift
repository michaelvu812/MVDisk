...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: NSDictionary?) -> Bool {
        ...
        NSLog("Free Disk Space Format %@", MVDisk.freeDiskSpaceFormat())
        NSLog("Total Disk Space Format %@", MVDisk.totalDiskSpaceFormat())
        NSLog("Used Disk Space Format %@", MVDisk.usedDiskSpaceFormat())
        NSLog("App Space Format %@", MVDisk.applicationSpaceFormat())
